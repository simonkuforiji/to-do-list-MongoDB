...
mongoose.connect("mongodb+srv://<name>:<password>@cluster0.6ntr2.mongodb.net/todolistDB?retryWrites=true&w=majority", {useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false});
